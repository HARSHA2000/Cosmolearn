...
export default function ProgramPage({ params }: Props) {
  ...
  const jsonLd = {
    ...
    audience: {
      ...
      educationalRole: fm.audience,
    },
    timeRequired: fm.duration,
    courseMode: fm.format,
    inLanguage: "en-IN",
        ...
        <div className="bg-slate-950 pt-24 pb-12">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {fm.aicte && <Badge variant="amber">AICTE Eligible</Badge>}
            ...
            <div className="space-y-6">
              ...
              <div className="bg-slate-900 rounded-xl p-6 text-center">
                ...
                <Button variant="amber" className="w-full" asChild>
                  <Link
                    href={`/contact?program=${encodeURIComponent(fm.title)}`}
                  >
                    Request a Proposal
                  </Link>
                </Button>
